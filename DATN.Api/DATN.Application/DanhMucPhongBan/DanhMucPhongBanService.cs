    ...
    public class DanhMucPhongBanService : IDanhMucPhongBan
    {
        ...
        public async Task<danh_muc_dto> Create(danh_muc_dto obj)
        {
            try
            {
                ...
                {
                    loai = 1,
                    detail = $"Thêm mới phòng ban \"{entity.ten}\"",
                    command = "PERM_ADD",
                });
                return obj;
            }
        ...
        public async Task<danh_muc_dto> Update(danh_muc_dto obj)
        {
            try
            {
                ...
                {
                    loai = 1,
                    detail = $"Sửa phòng ban \"{entity.ten}\"",
                    command = "PERM_EDIT",
                });
                return obj;
            }
        ...
        public async Task<bool> Delete(Guid id)
        {
            try
            {
                ...
                {
                    loai = 1,
                    detail = $"Xóa phòng ban \"{entity.ten}\"",
                    command = "PERM_DELETE",
                });
                return true;
            }
        ...
        public async Task<List<danh_muc_dto>> Get(string? keySearch)
        {
            try
            {
